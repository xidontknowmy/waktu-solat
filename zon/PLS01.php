...
/* 
	Waktu Solat Perlis - Kangar, Padang Besar, Arau
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PLS01.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Perlis - Kangar, Padang Besar, Arau<br>';
