...
/* 
	Waktu Solat Sabah Zon 1 - Sandakan, Bdr. Bkt. Garam, Semawang, Temanggong, Tambisan
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH01.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 1 - Sandakan, Bdr. Bkt. Garam, Semawang, Temanggong, Tambisan<br>';
