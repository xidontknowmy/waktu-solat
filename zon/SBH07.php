...
/* 
	Waktu Solat Sabah Zon 7 - Papar, Ranau, Kota Belud, Tuaran, Penampang, Kota Kinabalu
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH07.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 7 - Papar, Ranau, Kota Belud, Tuaran, Penampang, Kota Kinabalu<br>';
