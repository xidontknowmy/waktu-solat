...
/* 
	Waktu Solat Kedah Zon 2 - Pendang, Kuala Muda, Yan
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=KDH02';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Kedah 2 - Pendang, Kuala Muda, Yan<br>';
