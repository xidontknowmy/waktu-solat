...
/* 
	Waktu Solat Kelantan Zon 2 - Jeli, Gua Musang (Mukim Galas, Bertam)
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=KTN03.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Kelantan 2 - Jeli, Gua Musang (Mukim Galas, Bertam)<br>';
