...
/* 
	Waktu Solat Melaka - Bandar Melaka, Alor Gajah, Jasin, Masjid Tanah, Merlimau, Nyalas
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=MLK01.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Melaka - Bandar Melaka, Alor Gajah, Jasin, Masjid Tanah, Merlimau, Nyalas<br>';
