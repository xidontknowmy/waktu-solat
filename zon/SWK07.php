...
/* 
	Waktu Solat Sarawak Zon 7 - Samarahan, Simunjan, Serian, Sebuyau, Meludam
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK07';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 7 - Samarahan, Simunjan, Serian, Sebuyau, Meludam<br>';
