...
/* 
	Waktu Solat Selangor Zon 1 - Gombak,H.Selangor,Rawang, H.Langat,Sepang,Petaling, S.Alam
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SGR01';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Selangor 1 Gombak,H.Selangor,Rawang, H.Langat,Sepang,Petaling, S.Alam<br>';
