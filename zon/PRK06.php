...
/* 
	Waktu Solat Perak Zon 6 - Selama, Taiping, Bagan Serai dan Parit Buntar
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PRK06';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Perak 6 - Selama, Taiping, Bagan Serai dan Parit Buntar<br>';
