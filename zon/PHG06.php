...
/* 
	Waktu Solat Pahang Zon 6 - Bukit Fraser, Genting Higlands, Cameron Higlands
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PHG06.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Pahang 6 - Bukit Fraser, Genting Higlands, Cameron Higlands<br>';
