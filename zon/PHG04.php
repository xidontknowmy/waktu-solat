...
/* 
	Waktu Solat Pahang Zon 4 - Bentong, Raub, Kuala Lipis
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PHG04.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Pahang 4 - Bentong, Raub, Kuala Lipis<br>';
