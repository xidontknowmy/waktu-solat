...
/* 
	Waktu Solat Sabah Zon 5 - Kudat, Kota Marudu, Pitas, Pulau Banggi
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH05.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 5 - Kudat, Kota Marudu, Pitas, Pulau Banggi<br>';
