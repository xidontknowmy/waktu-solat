...
/* 
	Waktu Solat Johor Zon 3 - Kluang dan Pontian
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=JHR03.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Johor 3 - Kluang dan Pontian<br>';
