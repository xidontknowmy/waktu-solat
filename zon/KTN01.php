...
/* 
	Waktu Solat Kelantan Zon 1 - K.Bharu,Bachok,Pasir Puteh,Tumpat,Pasir Mas,Tnh. Merah,Machang,Kuala Krai,Mukim Chiku
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=KTN01.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Kelantan 1 - K.Bharu,Bachok,Pasir Puteh,Tumpat,Pasir Mas,Tnh. Merah,Machang,Kuala Krai,Mukim Chiku<br>';
