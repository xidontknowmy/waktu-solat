...
/* 
	Waktu Solat Perak Zon 3 - Pengkalan Hulu, Grik dan Lenggong
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PRK03';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Perak 3 - Pengkalan Hulu, Grik dan Lenggong<br>';
