...
/* 
	Waktu Solat Sarawak Zon 3 - Tatau, Suai, Belaga, Pandan, Sebauh, Bintulu
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK03';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 3 - Tatau, Suai, Belaga, Pandan, Sebauh, Bintulu<br>';
