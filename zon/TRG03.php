...
/* 
	Waktu Solat Terengganu Zon 3 - Hulu Terengganu
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=TRG03.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Terengganu 3 - Hulu Terengganu<br>';
