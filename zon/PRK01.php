...
/* 
	Waktu Solat Perak Zon 1 - Tapah,Slim River dan Tanjung Malim
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PRK01';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Perak 1 - Tapah,Slim River dan Tanjung Malim<br>';
