...
/* 
	Waktu Solat Pahang Zon 3 - Maran, Chenor, Temerloh, Bera, Jerantut
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PHG03.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Pahang 3 - Maran, Chenor, Temerloh, Bera, Jerantut<br>';
