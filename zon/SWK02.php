...
/* 
	Waktu Solat Sarawak Zon 2 - Niah, Bekenu, Miri, Sibuti, Marudi
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK02';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 2 - Niah, Bekenu, Miri, Sibuti, Marudi<br>';
