...
/* 
	Waktu Solat Sabah Zon 2 - Pinangah, Terusan, Beluran, Kuamut, Telupit
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH02.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 2 - Pinangah, Terusan, Beluran, Kuamut, Telupit<br>';
