...
/* 
	Waktu Solat Sabah Zon 4 - Tawau, Balong, Merotai, Kalabakan	
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH04.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 4 - Tawau, Balong, Merotai, Kalabakan	<br>';
