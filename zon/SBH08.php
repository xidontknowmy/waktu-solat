...
/* 
	Waktu Solat Sabah Zon 8 - Pensiangan, Keningau, Tambunan, Nabawan
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SBH08.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sabah 8 - Pensiangan, Keningau, Tambunan, Nabawan<br>';
