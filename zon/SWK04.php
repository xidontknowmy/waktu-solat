...
/* 
	Waktu Solat Sarawak Zon 4 - Igan, Oya, Balingian, Mukah, Dalat, Sibu, Kanowit, Kapit, Song
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK04';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 4 - Igan, Oya, Balingian, Mukah, Dalat, Sibu, Kanowit, Kapit, Song<br>';
