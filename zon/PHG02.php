...
/* 
	Waktu Solat Pahang Zon 2 - Kuantan, Pekan, Rompin, Muadzam Shah
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PHG02.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Pahang 2 - Kuantan, Pekan, Rompin, Muadzam Shah<br>';
