...
/* 
	Waktu Solat Selangor Zon 2 - Sabak Bernam, Kuala Selangor, Klang, Kuala Langat
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SGR02';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Selangor 2 - Sabak Bernam, Kuala Selangor, Klang, Kuala Langat<br>';
