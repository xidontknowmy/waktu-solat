...
/* 
	Waktu Solat Johor Zon 4 - Batu Pahat, Muar, Segamat, Gemas
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=JHR04.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Johor 4 - Batu Pahat, Muar, Segamat, Gemas<br>';
