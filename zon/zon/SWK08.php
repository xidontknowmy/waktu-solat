...
/* 
	Waktu Solat Sarawak Zon 8 - Kuching, Lundu, Bau dan Sematan
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK08';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 8 - Kuching, Lundu, Bau dan Sematan<br>';
