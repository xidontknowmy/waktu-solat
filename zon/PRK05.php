...
/* 
	Waktu Solat Perak Zon 5 - Teluk Intan, Bagan Datoh, Kg.Gajah,Sri Iskandar, Beruas,Parit,Lumut,Setiawan dan Pulau Pangkor
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=PRK05';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Perak 5 - Teluk Intan, Bagan Datoh, Kg.Gajah,Sri Iskandar, Beruas,Parit,Lumut,Setiawan dan Pulau Pangkor<br>';
