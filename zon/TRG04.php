...
/* 
	Waktu Solat Terengganu Zon 4 - Kemaman Dungun
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=TRG04.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Terengganu 4 - Kemaman Dungun<br>';
