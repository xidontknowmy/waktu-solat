...
/* 
	Waktu Solat Sarawak Zon 1 - Limbang, Sundar, Trusan, Lawas
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=SWK01';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Sarawak 1 - Limbang, Sundar, Trusan, Lawas<br>';
