...
/* 
	Waktu Solat N. Sembilan Zon 1 - Jempol, Tampin
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=NGS01.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: N. Sembilan 1 - Jempol, Tampin<br>';
