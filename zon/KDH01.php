...
/* 
	Waktu Solat Kedah Zon 1 - Kota Setar, Kubang Pasu, Pokok Sena
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=KDH01';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: Kedah 1 - Kota Setar, Kubang Pasu, Pokok Sena<br>';
