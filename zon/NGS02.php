...
/* 
	Waktu Solat N. Sembilan Zon 2 - Port Dickson, Seremban, Kuala Pilah, Jelebu, Rembau
...
$api = 'https://api.jomgeek.com/v1/waktusolat/?k=yEoNjYQ7K8tqImHN&a=NGS02.php';
$json = file_get_contents($api);
$retVal = json_decode($json, TRUE);

print 'Zon: N. Sembilan 2 - Port Dickson, Seremban, Kuala Pilah, Jelebu, Rembau<br>';
